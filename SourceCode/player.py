...
#Load SpaceShip
PLAYER_SPACE_SHIP = pygame.transform.scale(pygame.image.load("Infographics/Textures/ship2.png"),(70,70))
PLAYER_LASER = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Infographics/Textures/pow.png"),(30,30)),90)

#Load sounds
laser_fx = pygame.mixer.Sound("Infographics/SoundEffect/laser.wav")
laser_fx.set_volume(0.10)

explosion_fx = pygame.mixer.Sound("Infographics/SoundEffect/explosion.wav")
