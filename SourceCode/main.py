...
#Load sounds
Gameover_fx = pygame.mixer.Sound("Infographics/SoundEffect/GameoverSound.wav")
Gameover_fx.set_volume(0.50)

GetItem_fx = pygame.mixer.Sound("Infographics/SoundEffect/Get_Item.wav")
GetItem_fx.set_volume(0.20)

MouseClick_fx = pygame.mixer.Sound("Infographics/SoundEffect/ClickMouse.mp3")
...
#Background
BG =pygame.transform.scale(pygame.image.load("Infographics/Map/map.jpg"),(WIDTH,HEIGHT))

#Cutscene
CUTSCENE_1 = pygame.transform.scale(pygame.image.load("Infographics/Cutscene/Cover.png"),(WIDTH,HEIGHT))
CUTSCENE_2 = pygame.transform.scale(pygame.image.load("Infographics/Cutscene/ENEMY.png"),(WIDTH,HEIGHT))
CUTSCENE_3 = pygame.transform.scale(pygame.image.load("Infographics/Cutscene/BOSS.png"),(WIDTH,HEIGHT))
CUTSCENE_4 = pygame.transform.scale(pygame.image.load("Infographics/Cutscene/Item.png"),(WIDTH,HEIGHT))
CUTSCENE_5 = pygame.transform.scale(pygame.image.load("Infographics/Cutscene/Cover.png"),(WIDTH,HEIGHT))

#Endscene
ENDSCENE_BG = pygame.transform.scale(pygame.image.load("Infographics/Map/EndsceneBG.png"),(WIDTH,HEIGHT))
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("Infographics/Menu/Play_Rect.png"), pos=(300, 250), 
                            text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        SCORE_BUTTON = Button(image=pygame.image.load("Infographics/Menu/Play_Rect.png"), pos=(300, 400), 
                            text_input="SCORE", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("Infographics/Menu/Play_Rect.png"), pos=(300, 550), 
