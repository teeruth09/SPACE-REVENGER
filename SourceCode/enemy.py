...
# Load images
RED_SPACE_SHIP = pygame.transform.scale(pygame.image.load("Infographics/Textures/en2.png"),(60,60))
GREEN_SPACE_SHIP = pygame.transform.scale(pygame.image.load("Infographics/Textures/en1.png"),(70,70))
BLUE_SPACE_SHIP = pygame.transform.scale(pygame.image.load("Infographics/Textures/en3.png"),(70,70))
BOSS_SHIP = pygame.transform.scale(pygame.image.load("Infographics/Textures/Boss.png"),(90,90))


# Lasers
RED_LASER = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Infographics/Textures/redbullet.png"),(30,30)),180)
GREEN_LASER = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Infographics/Textures/greenbullet.png"),(30,30)),180)
BLUE_LASER = pygame.transform.rotate(pygame.image.load("Infographics/Textures/Bullet.png"),-90)
BOSS_LASER = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("Infographics/Textures/pow.png"),(80,80)),-90)
